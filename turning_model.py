...
# Baseline
return_x_val_accuracy(clf,X_train,y_train,kfold=5)
return_x_val_f1_macro(clf,X_train,y_train,kfold=5)
# Turned model
# Set parameters from gridsearch optimised params
turned_rfc=RandomForestClassifier(random_state=42)
turned_rfc.set_params(**grid_result_rf.best_params_)
print(turned_rfc.get_params)
return_x_val_accuracy(turned_rfc,X_train,y_train,kfold=5)
return_x_val_f1_macro(turned_rfc,X_train,y_train,kfold=5)
